...
local function encoding()
  return {
    ...
    separator = {
      right = dvim.core.lualine.configs.options.component_separators.left,
      left = dvim.core.lualine.configs.options.section_separators.right,
    },
  }
end
