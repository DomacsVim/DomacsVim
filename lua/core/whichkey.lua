...
M.defaults = {
  ...
  configs = {
    ...
    spec = {
      ...
      {
        "<leader>fc",
        "<cmd>edit " .. utils.join_paths(dvim_config_dir, "init.lua") .. "<cr>",
        desc = "Settings",
        mode = "n",
      },
      {
      ...
      {
        "<leader>tg",
        "<cmd>lua require('core.terminal').lazygit_toggle()<cr>",
        desc = "Lazygit",
        mode = "n",
      },
      {
      ...
      {
        "<leader>Dw",
        "<cmd>lua require('help').welcome()<cr>",
        desc = "Welcome",
        mode = "n",
      },
      {
        "<leader>Dc",
        "<cmd>lua require('help').show_all_commands()<cr>",
        desc = "Show all commands",
        mode = "n",
      },
      {
        "<leader>Dd",
        "<cmd>lua require('help').documentation()<cr>",
        desc = "Documentation",
        mode = "n",
      },
      {
        "<leader>Dk",
        "<cmd>lua require('help').keyboard_shortcuts_reference()<cr>",
        desc = "Keyboard shortcuts reference",
        mode = "n",
      },
      {
        "<leader>Dr",
        "<cmd>lua require('help').report_issue()<cr>",
        desc = "Report issue",
        mode = "n",
      },
      {
        "<leader>Dl",
        "<cmd>lua require('help').view_license()<cr>",
        desc = "View licence",
        mode = "n",
      },
      {
        "<leader>Da",
        "<cmd>lua require('help').about()<cr>",
        desc = "About",
        mode = "n",
      },
    },
